public class Main
{
    public static void main(String[] args)
    {
        ...
        System.out.println("First Integer: " + intOperandA + " Second Integer: " + intOperandB);
        ...
        double doubleOperandA = 56.78;
        double doubleOperandB = 12.34;
        ...
        System.out.println("First Double: " + doubleOperandA + " Second Double: " + doubleOperandB);
